...
<body>
    ...
    <div class="setting">
        ...
        <tr>
        <td width="120px">Lagu</td><td width="120px">Harga</td><td width="120px">Nama</td><td width="120px">Email</td><td width="120px">No Telepon</td><td width="120px">Catatan</td><td width="120px">Date</td><td width="120px">Hapus</td>
        <?php
				include "db.php";
				...
				while ($status=mysql_fetch_row($hasil_query)) {
					...
					echo "<tr/><td>$status[1]</td><td>$status[2]</td><td>$status[3]</td><td>$status[4]</td><td>$status[7]</td><td>$status[8]</td><td>$status[9]</td><td><a href='hapusrek.php?kode=$status[6]'>Hapus</a></td><tr>";
				}}
			?>
            </tr>
            </table></h3>
